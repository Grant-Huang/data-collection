...
// extension of the same rule: chips toggle on/off, and every toggle immediately re-joins the
// picks with "、" into the draft box so the expert sees the selection building up as they go
// (no separate "confirm selection" step) -- still never auto-sends, the expert can still edit
// before hitting 发送.
